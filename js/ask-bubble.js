...
(function () {
  ...
  var css = ''
    ...
    + '.rv-ask-panel{position:fixed;right:24px;bottom:88px;z-index:1001;width:340px;max-width:calc(100vw - 32px);'
    + 'height:min(500px,72vh);display:flex;flex-direction:column;background:var(--bg);color:var(--text);'
    ...
    + '.rv-ask-panel .ask-chat{flex:1;overflow-y:auto;display:flex;flex-direction:column;gap:11px;padding:12px 14px 4px;}'
    ...
    + 'padding:10px 13px;border-radius:4px 12px 12px 12px;}'
    + '.rv-ask-panel .bubble p{margin:0 0 7px;} .rv-ask-panel .bubble p:last-child{margin:0;}'
    ...
    + '.rv-ask-panel .ask-chips-wrap{padding:6px 14px 0;flex-shrink:0;}'
    ...
    + '.rv-ask-panel .chips{display:flex;flex-wrap:wrap;gap:6px;}'
    + '.rv-ask-panel .chip{background:var(--surface);border:1px solid var(--border);color:var(--text-muted);'
    + 'font-size:11.5px;padding:5px 10px;border-radius:var(--radius-pill,999px);cursor:pointer;transition:border-color .2s,color .2s;}'
    + '.rv-ask-panel .chip:hover{border-color:var(--accent);color:var(--text);}'
    + '.rv-ask-panel .ask-inputbar{display:flex;gap:8px;padding:10px 14px 12px;flex-shrink:0;}'
    ...
    + '@media (max-width:480px){.rv-ask-panel{right:16px;left:16px;width:auto;bottom:82px;height:58vh;}}';
